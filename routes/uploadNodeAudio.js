...
import { uploadAudioToS3 } from "../helpers/uploads/uploadAudioToS3.js";
...
//create chatbot
router.post("/", verifyToken, uploadAudioToS3, async function (req, res) {
  //request payload
  // const userId = req.auth.userId;
  const uid = req.user_info.main_uid;
  console.log(req.fileUrl);

  const audioUrl = req.fileUrl; // file url from S3 (middleware)
